  ...
  <form 
    ...
    onSubmit={async (e) => { 
      ...
      if (error) {
        ...
        alert("Submitted!");
        // FIX 1: Instantly update the list without refreshing
        setSubmissions((prev) => [...prev, newEntry]);
        // FIX 2: Clear the form fields
        e.target.reset();
        // FIX 3: Close the form view
        setActiveView(null);
      }
    }}
  >
    ...
    <button type="submit" className="w-full py-4 bg-emerald-600 font-bold uppercase hover:bg-emerald-500 transition-all">Send Data</button>
  </form>
